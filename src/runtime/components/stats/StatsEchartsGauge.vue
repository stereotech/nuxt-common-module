...
export default class StatsEchartsGauge extends Vue {
  @Prop({ type: Object, default: () => { return { name: '', value: 0, itemStyle: {} } } }) data!: { name: String, value: Number, itemStyle: Object }
      ...
      series: [
        {
          ...
          axisLine: { // линии диаграммы
            lineStyle: {
              width: 20
            }
          },
          splitLine: { // засечки как на часах Часы
            show: false,
            distance: 0,
            length: 10
          },
          axisTick: {// засечки как на часах Минуты
            show: false
          },
          axisLabel: { // засечки цифровые
            show: false,
            distance: 50
          },
          data: [],
  ...
  get chart (): ECharts | null {
    return this.$refs.echartDiagram?.inst ?? null;
  }
