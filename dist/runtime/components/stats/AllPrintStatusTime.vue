...
let StatsAllPrintStatusTime = class extends Vue {
  get chartOptions() {
    return {
...
], StatsAllPrintStatusTime.prototype, "printStatusTime", 2);
__decorateClass([
  Watch("allPrintStatusArray")
], StatsAllPrintStatusTime.prototype, "allPrintStatusArrayChanged", 1);
StatsAllPrintStatusTime = __decorateClass([
  Component({
...
export {
  StatsAllPrintStatusTime as default
};
</script>
